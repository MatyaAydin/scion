...
LEARNING_RATES=(1e-6 1e-5 5e-5 1e-4 0.00036 1e-3 5e-3 1e-2)
LOGDIR="logs_prescion_lr"
...
torchrun --standalone --nproc_per_node=4 ./train_mousse_scion.py --lr ${LR} --log-dir ${LOGDIR}
EOF
done
...
def main(args, optim_args):
    ...
    optimizer1 = ScionSteepest(optim_groups, unconstrained=args.unconstrained, **optim_args)
    ...
    for step in range(args.num_iterations + 1):
        ...
        model.train()
        accumulated_dual_norms = {"Spectral":0., "Sign": 0.}
        ...
        for opt, sched in zip(optimizers, schedulers):
            opt.step()
            sched.step()
            accumulated_dual_norms["Sign"] += opt.dual_norms["Sign"] / train_accumulation_steps
            accumulated_dual_norms["Spectral"] += opt.dual_norms["Spectral"] / train_accumulation_steps
        # null the gradients

...
optimizer1 = ScionSteepest(optim_groups, lr=args.learning_rate, momentum=args.momentum, unconstrained=args.unconstrained)
...
if master_process:
    ...
    logfile = f'logs/logs_steepest_scion_{args.learning_rate}.txt'
    # create the log file

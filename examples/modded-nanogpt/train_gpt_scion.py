...
class Hyperparameters:
    ...
    num_iterations : int = 7500 # number of iterations to run
    learning_rate : float = 0.00036
    warmup_iters : int = 0
    warmdown_iters : int = 2250 # number of iterations of linear warmup/warmdown for triangular or trapezoidal schedule
